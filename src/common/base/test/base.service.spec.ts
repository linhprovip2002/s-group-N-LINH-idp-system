...
describe('BaseService', () => {
  ...
  describe('getOneByIdOrFail', () => {
    it('should throw NotFoundException', async () => {
      await expect(service.getOneByIdOrFail('1')).rejects.toThrow(
        NotFoundException,
      );
    });
    it('should return entity', async () => {
  ...
  describe('update', () => {
    ...
    it('should throw NotFoundException', async () => {
      await expect(service.update(options, data)).rejects.toThrow(
        NotFoundException,
      );
    });
  ...
  describe('updateById', () => {
    ...
    it('should throw NotFoundException', async () => {
      await expect(service.updateById('1', data)).rejects.toThrow(
        NotFoundException,
      );
    });
    it('should update entity', async () => {
  ...
  describe('softRemove', () => {
    ...
    it('should throw NotFoundException', async () => {
      await expect(service.softRemove(options)).rejects.toThrow(
        NotFoundException,
      );
    });
    it('should return entity', async () => {
  ...
  describe('softRemoveById', () => {
    it('should throw NotFoundException', async () => {
      await expect(service.softRemoveById('1')).rejects.toThrow(
        NotFoundException,
      );
    });
    it('should return entity', async () => {
